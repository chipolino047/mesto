...
const popupAdd = document.querySelector('.popup__add_img');
const closeAddImg = document.querySelector('#popup-close-img');
...
const formAddCards = document.querySelector('.form__add_img');
